...
from alice.skills.audioservice import AudioService
...
class PlaybackControlSkill(AliceSkill):
    def __init__(self):
    ...
    def voc_match_exact(self, utt, voc_filename, lang=None):
        ...
        folder of alice-core. The result is cached to avoid hitting the
        ...
        if cache_key not in self.voc_match_cache:
            # Check for both skill resources and alice-core resources
    ...
    # common messages:
    #   self.add_event('alice.audio.service.next', SKILL_HANDLER)
    #   self.add_event('alice.audio.service.prev', SKILL_HANDLER)
    #   self.add_event('alice.audio.service.pause', SKILL_HANDLER)
    #   self.add_event('alice.audio.service.resume', SKILL_HANDLER)
