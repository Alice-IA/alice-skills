...
from alice.util.format import pronounce_number, nice_duration, join_list
from alice.util.parse import extract_duration
from alice.util.time import now_utc, now_local
from .skill import (
    CountdownTimer,
...
class TimerSkill(AliceSkill):
    ...
    def initialize(self):
        ...
        self.add_event(
            "alice.speech.recognition.unknown", self.handle_speech_recognition_unknown
        )
