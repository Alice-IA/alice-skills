Feature: volume control
  ...
  Scenario Outline: turning up the volume
    Given an english speaking user
     ...
     Then "alice-volume" should increase the volume
  ...
  Scenario Outline: turning down the volume
    Given an english speaking user
     ...
     Then "alice-volume" should decrease the volume
  ...
  Scenario Outline: change volume to a number between 1 and 10
    Given an english speaking user
     ...
     Then "alice-volume" should reply with dialog from "set.volume.dialog"
  ...
  Scenario Outline: change volume to a percent of 100
    Given an english speaking user
     ...
     Then "alice-volume" should reply with dialog from "set.volume.percent.dialog"
  ...
  Scenario Outline: max volume
    Given an english speaking user
     ...
     Then "alice-volume" should reply with dialog from "max.volume.dialog"
  ...
  Scenario Outline: volume status
    Given an english speaking user
     ...
     Then "alice-volume" should reply with dialog from "volume.is.dialog"
  ...
  Scenario Outline: reset volume
    Given an english speaking user
     ...
     Then "alice-volume" should reply with dialog from "reset.volume.dialog"
  ...
  Scenario Outline: mute audio
    Given an english speaking user
     ...
     Then "alice-volume" should reply with dialog from "mute.volume.dialog"
